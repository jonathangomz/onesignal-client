...
class OneSignal {
  ...
  /**
   * Validate that the app exist and that the client can communicate with the provider.
   ...
   * @returns {Promise<SuperAgentRequest>} A promise with the response for the call. _See properties on https://visionmedia.github.io/superagent/#response-properties_.
   */
  async getApp() {
    const path = `${API_URL}/apps/${this.appId}`;
